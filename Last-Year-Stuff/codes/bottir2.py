...
class Player71():
    ...
    def getBlockStatus(self, block):
        ...
        if block[0][0] == block[1][1] == block[2][2] == block[3][3] and block[1][1] in (1,
                                                                                        2):
            return block[1][1]
        if block[0][3] == block[2][1] == block[1][2] == block[3][0] and block[2][1] in (1,
                                                                                        2):
            return block[2][1]
    ...
    def alphaBetaPruning(self, currentBoard, currentBlockStatus, alpha, beta, flag, prevMove, depth):
        ...
        if depth <= 0:
            return (
             self.getBoardScore(currentBoard, currentBlockStatus), (), 0)
